...
app.service('ChatService',['$http','$q','$rootScope','$window', function($http,$q,$rootScope,$window){
	...
	var BASE_URL = 'http://localhost:9014/friendsbackend/';
    ...
    service.SOCKET_URL = "/friendsbackend/privatechat";
    ...
    var getids = function(item) {
		...
		return $http.post('http://localhost:9014/friendsbackend/talk/getids',item).then(function(response) {
